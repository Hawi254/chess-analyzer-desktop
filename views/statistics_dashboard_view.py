...
class StatisticsDashboardView(QWidget):
    ...
    def update_performance_funnel(self, data: dict):
        """Delegates funnel data to the Command Center tab."""
        self.command_center_view.update_performance_funnel(data)

    def plot_accuracy_trend(self, data: list):
        """Delegates trend data to the Command Center tab."""
        self.command_center_view.plot_accuracy_trend(data)
    ...
    def plot_decision_matrix(self, data: list):
        """Delegates decision matrix data to the Crucible tab."""
        self.crucible_view.plot_decision_matrix(data)

    def plot_tactical_signature(self, data: list):
        """Delegates tactical signature data to the Crucible tab."""
        self.crucible_view.plot_tactical_signature(data)
